...
class InferenceEngine:
    ...
    def _load_model(self):
        try:
            ...
            snapshot_dir = os.path.join(
                os.getenv("HF_HOME", "/mnt/hf-cache"),
                "hub",
            ...
            log.error("timesfm_not_installed")
            raise
    ...
    def _run_fallback(self, series: list) -> QuantileTrajectory:
        if not series:
            ...
            return QuantileTrajectory(p10=flat, p50=flat, p90=flat, model_used="fallback")
        ...
        return QuantileTrajectory(p10=p10, p50=p50, p90=p90, model_used="fallback")
